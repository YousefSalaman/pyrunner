...
if __name__ == "__main__":
    ...
    const = sources.Constant(main_sys, value=42)
    const_1 = sources.Constant(main_sys, value=3.1415)
    const_2 = sources.Constant(main_sys, value='np.array([1,2,3])')
    const_3 = sources.Constant(main_sys, value=1)

    # Add the Sum blocks
    adder = math_op.Sum(main_sys, comp_signs="-+")
    adder_1 = math_op.Sum(main_sys, comp_signs='+--')
    adder_2 = math_op.Sum(main_sys, comp_signs='-')
